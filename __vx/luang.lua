-- https://github.com/ImagicTheCat/Luang
Luang = {}
local Lang = {}
        ...
        if type(el) == "table" then -- table, continue 
            return setmetatable({}, {
                __index = function(t, k)
                    return resolve_path(el, path, t, k)
                end,
                __tostring = function(t)
                    return path
                end,
                __call = function(t, args, default)
                    return replace_args(default, args) or path
                end
            })
        else -- value
            return setmetatable({}, {
...
setmetatable(Luang, {
    __call = function(t)
        local obj = {}
        obj.dict = {}
        obj.lang = setmetatable({}, {
            __index = function(t, k)
                return resolve_path(obj.dict, "", t, k)
            end
        })
